...
def draw(canvas):
    ...
    if ball_pos[0] >= WIDTH - BALL_RADIUS - PAD_WIDTH and ball_pos[1] >= paddle2_pos and ball_pos[1] <= (paddle2_pos + PAD_HEIGHT):
        ball_vel[0] = - 1.1 * ball_vel[0]   
